...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250517095919_updateExamQuestionDetail")]
    partial class updateExamQuestionDetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ExamQuestionDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExamQuestionDetail", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.ExamStructDetail", b =>
                {
                    ...
                    b.ToTable("ExamStructDetail", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.QuestionBank", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateOnly(2025, 5, 17),
                            Language = "Hàn",
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ce8ceeec-5624-425e-8bbe-13fd1e81978d"),
            ...
            modelBuilder.Entity("Domain.Entities.ExamQuestionDetail", b =>
                {
                    b.HasOne("Domain.Entities.ContentBlock", "ContentBlock")
                        .WithOne("ExamQuestionDetail")
                        .HasForeignKey("Domain.Entities.ExamQuestionDetail", "ContentBlockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.ExamQuestion", "ExamQuestion")
                        .WithOne("ExamQuestionDetail")
                        .HasForeignKey("Domain.Entities.ExamQuestionDetail", "ExamQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.ContentBlock", b =>
                {
                    b.Navigation("ExamQuestionDetail");
